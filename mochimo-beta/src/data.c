...
#define CORELISTLEN 8
#if CORELISTLEN > RPLISTLEN || CORELISTLEN > CPLISTLEN
...
word32 Contend_ip;      /* peer who reported contention */
time_t Contend_time;    /* time of Contend_ip */
byte Contention;        /* contention level to contend() */
