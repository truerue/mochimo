...
#define VERSIONSTR  "25"   /*   as printable string */
...
#include "miner.c"
#include "update.c"
#include "init.c"       /* read Coreplist[] and SYNC       */
...
int main(int argc, char **argv)
{
   ...
   if(get16(endian) != 0x1234)
      fatal("Contact your vendor for a big-endian version.");
   ...
   plog("\nMochimo Server patch level %d  Built on %s %s\n"
